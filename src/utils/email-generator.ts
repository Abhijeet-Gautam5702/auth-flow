  ...
  OTPonEmail(otp: string) {
    ...
    <body>
        <div class="email-container">
            <h1>Welcome to AuthWave!</h1>
            <p>Hello,</p>
            <p>Thank you for registering with AuthWave! To complete your authentication setup, please use the following OTP:</p>
            <p class="otp">${otp}</p> 
            <p><strong>Note:</strong> This OTP will be valid for the next <strong>15 minutes</strong> only.</p>
            <p>If you did not request this, please ignore this email.</p>
            <footer>Regards, <br> The AuthWave Team</footer>
        </div>
    </body>
